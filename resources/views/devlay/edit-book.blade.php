    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-5 mb-3">
                <form method="post" action="{{ route('dashboard.update', $book->id) }}" enctype="multipart/form-data" class="flex flex-column justify-center p-4 mt-[15vh] card-body rounded-lg bg-slate-700 shadow-lg">
                    @csrf
                    @method('PUT')
                    <h1 class="flex text-slate-100 justify-center font-medium text-2xl mb-2">Edit Data Buku</h1>
                    ...
                    <input type="text" class="form-control mb-3" placeholder="Judul buku" name="title" id="title" value="{{ $book->title }}">
                    ...
                    <input type="number" min="1500" step="1" class="form-control mb-3" name="year" id="date" value="{{ $book->year }}">
